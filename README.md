...
## 🔑 dev.tfvars — змінні середовища

Всі параметри для розгортання інфраструктури зберігаються у файлі `terraform/environments/dev/dev.tfvars`. Ось основні змінні, які там використовуються (крім SSH ключа):

| Змінна                   | Значення (приклад)         | Опис                              |
|--------------------------|----------------------------|-----------------------------------|
| aws_region               | "eu-central-1"             | Регіон AWS                        |
| environment              | "dev"                      | Назва середовища                  |
| resource_name            | "sk-step-project-3"        | Префікс для ресурсів              |
| instance_type            | "t3.micro"                 | Тип EC2 інстансу                  |
| vpc_cidr                 | "10.0.0.0/16"              | CIDR VPC                          |
| vpc_name                 | "dev-vpc"                  | Назва VPC                         |
| public_subnet_cidr       | "10.0.1.0/24"              | CIDR публічної підмережі          |
| private_subnet_cidr      | "10.0.2.0/24"              | CIDR приватної підмережі          |
| availability_zone        | "eu-central-1a"            | Зона доступності                  |
| public_subnet_name       | "sk-dev-public-subnet"     | Назва публічної підмережі         |
| private_subnet_name      | "sk-dev-private-subnet"    | Назва приватної підмережі         |
| igw_name                 | "sk-dev-igw"               | Назва Internet Gateway            |
| public_route_table_name  | "sk-dev-public-rt"         | Назва публічної route table       |
| private_route_table_name | "sk-dev-private-rt"        | Назва приватної route table       |
| eip_name                 | "sk-dev-eip"               | Назва Elastic IP для NAT          |
| nat_name                 | "sk-dev-nat"               | Назва NAT Gateway                 |
| ssh_allowed_cidr         | "0.0.0.0/0"                | CIDR для доступу по SSH           |
| jenkins_allowed_cidr     | "0.0.0.0/0"                | CIDR для доступу до Jenkins       |
| master_private_ip_cidr   | "10.0.1.0/32"              | CIDR для доступу master до worker |
| public_key_content       | "ssh-rsa AAAAB3NzaC1y..."  | SSH для доступу в мережі          |


> **dev.tfvars** дозволяє швидко змінювати параметри інфраструктури для різних середовищ (dev, prod тощо) без редагування основних .tf-файлів.
...
|----|------------------------|-------------------------------------|-------------------------------------------------------------------------------|
| 1  | VPC                    | Основна мережа                      | ![VPC](Screens/7.1_vpc.png)                                                   |
| 2  | Public Subnet          | Публічна підмережа                  | ![Public Subnet](Screens/8.1_public_subnet.png)                               |
| 3  | Private Subnet         | Приватна підмережа                  | ![Private Subnet](Screens/8.2_private_subnet.png)                             |
| 4  | Public Route Table     | Таблиця маршрутів                   | ![RouteTable](Screens/9.1_public_route_table.png)                             |
| 5  | Pub. Route Table Assoc.| Асоціація маршрутів                 | ![RouteTableAssoc](Screens/9.1.1_public_route_table_subnet_associations.png)  |
| 6  | Privat Route Table     | Таблиця маршрутів                   | ![RouteTable](Screens/9.2_private_route_table.png)                            |
| 7  | Pri. Route Table Assoc.| Асоціація маршрутів                 | ![RouteTableAssoc](Screens/9.2.1_private_route_table_subnet_associations.png) |
| 8  | Internet Gateway       | Доступ до інтернету                 | ![IGW](Screens/10.1_internet_getway.png)                                      |
| 9  | NAT Gateway            | Вихід у інтернет з приватної мережі | ![NATGW](Screens/11.1_nat_getway.png)                                         |
| 10 | Pub.Security Groups    | Firewall правила                    | ![SG](Screens/12.1_public_security_group.png)                                 |
| 11 | Pub.SG Outbound rule   | Firewall правила                    | ![SG](Screens/12.1.2_public_security_group_outbound_rule.png)                 |
| 12 | Pub.SG Inbound rule    | Firewall правила                    | ![SG](Screens/12.1.1_public_security_group_inbound_rule.png)                  |
| 13 | Pri.Security Groups    | Firewall правила                    | ![SG](Screens/12.2_private_security_group.png)                                |
| 14 | Pri.SG Outbound rule   | Firewall правила                    | ![SG](Screens/12.2.2_private_security_group_outbound_rule.png)                |
| 15 | Pri.SG Inbound rule    | Firewall правила                    | ![SG](Screens/12.2.1_private_security_group_inbound_rule.png)                 |
